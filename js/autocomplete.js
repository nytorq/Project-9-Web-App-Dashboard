(function (global, factory) {
  ...
  function autocomplete(settings) {
      ...
      // Where Denys applies the class name 'autocomplete' -Charlie
      // container.className = "autocomplete " + (settings.className || "");

      // My css declaration
      container.className = "dropdown " + (settings.className || "");
      ...
      function update() {
          ...
          var render = function (item, currentValue) {
              ...
              itemElement.className = "dropdown__value";
          ...
          if (items.length < 1) {
              if (settings.emptyMsg) {
                  ...
                  empty.className = "dropdown__value empty";
